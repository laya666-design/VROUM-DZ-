                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _ProfileOption(
                        icon: Icons.moped,
                        label: t('Scooter', 'سكوتر'),
                        selected: _selected == 'scooter',
                        accentColor: widget.config.primaryColor,
                        onTap: () => setState(() => _selected = 'scooter'),
                      ),
                      const SizedBox(height: 12),
                      _ProfileOption(
                        icon: Icons.directions_car,
                        label: t('Voiture + Moto', 'سيارة + دراجة'),
                        selected: _selected == 'voiture_moto',
                        accentColor: widget.config.primaryColor,
                        onTap: () =>
                            setState(() => _selected = 'voiture_moto'),
                      ),
                      const SizedBox(height: 12),
                      _ProfileOption(
                        icon: Icons.directions_car,
                        label: t('Voiture + Scooter', 'سيارة + سكوتر'),
                        selected: _selected == 'voiture_scooter',
                        accentColor: widget.config.primaryColor,
                        onTap: () =>
                            setState(() => _selected = 'voiture_scooter'),
                      ),
                      const SizedBox(height: 12),
                      _ProfileOption(
                        icon: Icons.sync_alt,
                        label: t('Tout (voiture, moto, scooter)',
                            'الكل (سيارة، دراجة، سكوتر)'),
